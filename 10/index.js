...
function startTheApp() {
    return __awaiter(this, void 0, void 0, function () {
        var adminsList, usersList, serverTime, queueLength, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    serverTime = _a.sent();
                    console.log("   ".concat(new Date(serverTime).toLocaleString()));
                    console.log();
                    console.log('Coffee machine queue length:');
                    return [4 /*yield*/, exports.api.requestCoffeeMachineQueueLength()];
                case 4:
                    queueLength = _a.sent();
                    console.log("   ".concat(queueLength));
                    return [3 /*break*/, 6];
                case 5:
                    e_1 = _a.sent();
                    console.log("Error: \"".concat(e_1.message, "\", but it's fine, sometimes errors are inevitable."));
                    return [3 /*break*/, 6];
